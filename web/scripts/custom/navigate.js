var Andromeda={
		...
		showHospitalLoginPage : function() {
	 		var path = "/hospital/html/hospital.html";
			Andromeda.showPage(path, "name");
		},
		...
		showReceptionistAppointmentPage : function() {
			var path = "/hospital/html/receptionistappointment.html";
			Andromeda.showPage(path, "backDiv");
		},
		showViewAppointmentPage : function() {
			var path = "/hospital/html/viewappointment.html";
			Andromeda.showPage(path, "backDiv");
		},
		showSpecialityPage : function() {
			var path = "/hospital/html/speciality.html";
			Andromeda.showPage(path, "backDiv");
		},
		showHospitalPage : function() {
			var path = "/hospital/html/addhospital.html";
			Andromeda.showPage(path, "backDiv");
		},	
		...
		showFeedbackPage : function() {
			var path = "/hospital/html/conreport.html";
			Andromeda.showPage(path, "backDiv");
		},	
